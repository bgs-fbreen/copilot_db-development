-- ============================================================================
-- Migration: Add Trial Entry System
-- Created: 2025-12-28
-- Description: Creates trial_entry and trial_entry_line tables with validation
--              views and functions for Part 02 of the staging workflow
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS acc.trial_entry (
...
CREATE INDEX IF NOT EXISTS idx_trial_entry_date ON acc.trial_entry(entry_date);
CREATE INDEX IF NOT EXISTS idx_trial_entry_entity ON acc.trial_entry(entity);
CREATE INDEX IF NOT EXISTS idx_trial_entry_status ON acc.trial_entry(status);
CREATE INDEX IF NOT EXISTS idx_trial_entry_staging ON acc.trial_entry(source_staging_id);

-- ============================================================================
-- TRIAL ENTRY LINE - Debit/Credit Lines
-- ============================================================================

CREATE TABLE IF NOT EXISTS acc.trial_entry_line (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_trial_line_entry ON acc.trial_entry_line(entry_id);
CREATE INDEX IF NOT EXISTS idx_trial_line_gl ON acc.trial_entry_line(gl_account_code);
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE conname = 'chk_debit_or_credit' 
        AND conrelid = 'acc.trial_entry_line'::regclass
    ) THEN
